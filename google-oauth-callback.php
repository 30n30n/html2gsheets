<!--
use this page to get the tokens , more info on https://www.youtube.com/watch?v=BxqfwfQi0jk
-->
<!DOCTYPE html>
<html>
<head>
...
<?php
// Config
$redirect = "http://pershop.biz/gsheets/google-oauth-callback.php"; // Enter your API Callback URL here
$client_id = "375959856673-c40c92eo1c5fi6e5na6db0sdlknoq0lb.apps.googleusercontent.com"; // Enter your API Client ID Here
$client_secret = "0QDpA52D_esPsWlhJl7kWRDQ"; // Enter your API Client Secret here
// Check Code
if(empty($_GET['code'])) {
	// Authorization Link
