/* 
append html form to Googlesheet
*/
...
function submit_form() {    
    ...
    if(complete) {		
		...
		row = row.slice(0, -1);		
        // Config
        var gs_sid = '1ML0uTj68drtApxcKaiwFKO6g8bUyodGwZ-2ohn6KDeY'; // Enter your Google Sheet ID here
        var gs_clid = '375959856673-c40c92eo1c5fi6e5na6db0sdlknoq0lb.apps.googleusercontent.com'; // Enter your API Client ID here
        var gs_clis = 'here'; // Enter your API Client Secret here
        var gs_rtok = 'here'; // Enter your OAuth Refresh Token here
        var gs_atok = false;
        ...
        xhr.onload = function() {            
            ...
            if(gs_atok) {
                ...
                xxhr.onload = function() {
					if(xxhr.status == 200) {
						// Success
						$('#message').html('<p>Row Added to Sheet | <a href="http://pershop.biz/gsheets/google-sheets-api.php">Add Another &raquo;</a></p><p>Response:<br/>'+xxhr.responseText+'</p>');
						} else {
						// Fail
